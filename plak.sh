...
<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='20' fill='%23f6f1e8'/><rect x='10' y='50' width='80' height='40' fill='%232f36fa'/></svg>">
